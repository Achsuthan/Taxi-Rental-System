...
<html>
	...
	<td colspan="4"><input type="text" name="search" placeholder="Search" onkeydown="searchq($output);"/>	
		...
		echo "<div class='who_3'>";
		 while($row = mysql_fetch_array($retval, MYSQL_NUM))
			{
				echo"<p>Question :{$row[2]}  <br/> <br/>".
         			"Answers : {$row[1]} <br> </p><hr>";
			} 
		echo "</div></br>";	
		...
		<!--<form method="post"  action="connect.php" class="who_3">
			<p> Input Your question : <input type="text" name="Ques" align="center" style="width: 400px;" required placeholder="Your Question" title="Please insert the question" pattern="[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}[a-zA-Z]{0,}[ ]{0,}" /></p>
			<p><input type="submit" name="submit" align="center" value="Submit the question"></p>
		</form>-->
